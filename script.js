...
y should not be considered a vowel.>>  a, e, i, o, and u
...
const calculateTip = (amount, percentage) => {
    return amount*((Math.round(percentage))/100)
}
...
const convertTemperature = (temperature, CF) => {
     if(CF === 'F'){
...
const basicCalculator = (n1, n2, st) => {
